        ...
        ["tote"] = new FlowDef
        {
            ...
            [
                N("browser", "Browser", "Usuário", "User", "googlechrome", "#e8eef1", "client", 0, 0,
                    "Entrada da vitrine. O checkbox do Turnstile minta a sessão; não há senha.",
                    "Showcase entry. The Turnstile checkbox mints the session; there is no password.",
                    "Workspace ADMIN efêmero (~2h), isolado por visitante.",
                    "Ephemeral ADMIN workspace (~2h), isolated per visitor.",
                    "GET https://demo.tote.galasse.dev/"),
        ...
        ["aws-ops-labs"] = new FlowDef
        {
            ...
            [
                ...
                N("fn", "Lambda 128 MB", "Function URL", "Function URL", "amazonwebservices", "#ff9900", "compute", 1, 0,
                    ...
                    "AuthType: NONE",
                    "https://github.com/dangalasse/portfolio/tree/main/labs/always-free"),
                ...
                N("kms", "KMS", "GenerateRandom", "GenerateRandom", "amazonwebservices", "#dd344c", "data", 2, 1,
                    ...
                    "kms.generate_random(NumberOfBytes=32)"),
        ...
        ["pipeview"] = new FlowDef
        {
            ...
            [
                ...
                N("gha", "GitHub Actions", "CI", "CI", "githubactions", "#2088FF", "ci", 1, 0,
                    "Jobs reais: lint, types, testes, build. O run na UI é este, inclusive se falhou.",
                    "Real jobs: lint, types, tests, build. The run in the UI is this one, including failures.",
                    "Abra a aba Actions. Verde de marketing não é o objetivo.",
                    "Open the Actions tab. A marketing-green screenshot is not the point.",
